            ...
            <Center>
              <ColumnsWrapper>
                <Box>
                  ...
                  {/* <HomeBtn href={'/'}><Button black block >Continue shopping...</Button></HomeBtn> */}
                </Box>
              </ColumnsWrapper>
            </Center>
          </>
                                ...
                                <tbody>
                                    {products.map(product=>(
                                        <tr key={product._id}>
                                            ...
                                            <td>
                                                LKR {cartProducts.filter(id => id === product._id).length * product.price}
                                            </td>
                                        </tr>
                                    ))}
                                    <tr>
                    ...
                    {!!cartProducts?.length && (
                        <Box>
                            <h2>Order information</h2>
                                ...
                                <Button black block onClick={goToPayment} >Confirm order</Button>
                        </Box>
                    )}
                </ColumnsWrapper>
            </Center>
